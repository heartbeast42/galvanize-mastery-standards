...
There are notes in the app that tell you when and how the encryption is happening based on inputs. The usage of local variables make it easier to see what is happening inside each function making it easier for a partner to collaborate, update, or take over the project. I would say pseudo code in your functions so we know what is happening for a non crypto-engineer. on line on line 42 of index.js where the "cypher" code happens. Is that making a new
